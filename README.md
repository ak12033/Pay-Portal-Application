...
Welcome to the Pay Portal Application! This project aims to replicate the basic functionality of Paytm, allowing users to perform transactions, view their account balance, and interact with other users.
